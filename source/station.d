...
struct Station
{
	...
	*/
	...
	return (scaledSignal*signalImportance+batteryValue*batteryImportance)/(signalImportance+batteryImportance);
    }
	@("calcStationHealth returns the correct max and min values")
	unittest
	{
	    Station* station = new Station(1,"foo", StationType.Portable, "bar", 0, 0, WorkingMode.Voice);
	    station.strength = 10;
